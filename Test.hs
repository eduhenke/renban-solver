...
computeActions board actions = foldl fillCellBoard board actions
...
main = do
  ...
  print $ isSequenceInvalid [Just 2, Just 1, Nothing, Just 2]

  print "solved/invalid"
  ...
  print $ isJust $ solve $ board
  print $ isJust $ solve $ board4
